...
:: Average-Analysi, make a copy of this file and rename it
...
:: Sparkle-Average-Analysi directory (where you found this file).
...
:: are any new updates.
::
:: Place your path to Sparkle-Average-Analysis here
set location="C:\Users\Name\Documents\Sparkle-Average-Analysis\"
cd %location%
::
...
title Sparkle-Average-Analysis

:: Get versions of Sparkle-Average-Analysis
git remote update
...
:updatePrompt
set /p "answer=Update Sparkle-Average-Analysis? (y or n): "
goto :answerCheck
